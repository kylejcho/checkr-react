        ...
        <div id="sidebar">
            ...
            <div id="sidebarShortcuts" className="sidebarTabsContainer">
                <div id="sidebarShortcutsToday" className="sidebarShortcut sidebarTab">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512"><rect fill="none" stroke="#697384" strokeLinejoin="round" strokeWidth="32" x="48" y="80" width="416" height="384" rx="48"/><line fill="none" stroke="#697384" strokeLineJoin="round" strokeWidth="32" strokeLineCap="round" x1="128" y1="48" x2="128" y2="80"/><line fill="none" stroke="#697384" strokeLineJoin="round" strokeWidth="32" strokeLineCap="round" x1="384" y1="48" x2="384" y2="80"/><line fill="none" stroke="#697384" strokeLineJoin="round" strokeWidth="32" strokeLineCap="round" x1="464" y1="160" x2="48" y2="160"/><text className = "todayIconNumber" x="50%" y="62%" text-anchor="middle" fill="#697384" fontSize="250px" fontFamily="Inter" textLength="55%" dy=".3em"></text></svg>
                    <p>Today</p>
