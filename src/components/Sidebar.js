    ...
    return (
        <>
            <div id="sidebar" ref={sidebar}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512" style={{fill:'none',strokeLinecap:'round',strokeLinejoin:'round',strokeWidth:'32px', stroke: contentType === 'home' && '#3880ff'}}>
                ...
                <div id="sidebarShortcuts" className="sidebarTabsContainer">
                    <div id="sidebarShortcutsToday" className="sidebarShortcut sidebarTab" onClick={()=>changeContent('today')} style={{color: contentType === 'today' && '#3880ff'}}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512">
                            <rect fill="none" stroke="#697384" strokeLinejoin="round" strokeWidth="32" x="48" y="80" width="416" height="384" rx="48" style={{stroke: contentType === 'today' && '#3880ff'}}/>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512" stroke="#697384" fill="#697384" style={{stroke: contentType === 'week' && '#3880ff', fill: contentType === 'week' && '#3880ff'}}>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512" style={{stroke: contentType === 'all' && '#3880ff'}}><title>ionicons-v5-o</title>
                ...
                <p id="sidebarListsTitle" className="sidebarTitle" onClick={()=>changeContent('list')}>
