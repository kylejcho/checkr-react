   ...
   return (
      ...
      >
         ...
         >
            ...
            <div id='inputDueDateContainer'>
               ...
               >
                  <div id='inputList'>
                     ...
                     <p id='listSelectionName'>
                        {listSelection ? listSelection : 'Add to list'}
                     </p>
                  </div>
                  <InputListOptions
                     tasks={tasks}
            ...
            <button id='taskFormAddButton' onClick={handleAddTaskClick}>
               Add task<ion-icon name='arrow-forward-outline'></ion-icon>
            </button>
         </motion.div>
      </motion.div>
   )
